...
class TestHelpers(unittest.TestCase):
    ...
    def test_create_files(self):
        ...
        whitespace_config = main.HandlebarsWhitespaceConfig(
            ...
            indent_single_control_tag_to_adjacent_depth=True,
        )
        main._create_files(
        ...
        self.assertEqual(
            {"tests/in_dir/partial_header.handlebars", "tests/in_dir/api.handlebars"},
            set(handlebars_files),
        )
        self.assertEqual(set(in_file_to_out_file_map.values()), set(handlebars_files))
        with open("tests/in_dir/partial_header.handlebars") as file:
            partial_header_txt = file.read()
        self.assertEqual(
            partial_header_txt,
            '\n'.join([
                '"""',
    ...
    def test_convert_handlebars_to_mustache_tag_whitespace_config(self):
        ...
        out_txt, ambiguous_tags = main._convert_handlebars_to_mustache(
            in_txt,
            handlebars_tag_set,
            main.HandlebarsWhitespaceConfig(remove_whitespace_before_open=True),
        )
        expected_out_txt = "\n".join(
            [
                "{{~#if a}}",
        ...
        out_txt, ambiguous_tags = main._convert_handlebars_to_mustache(
            in_txt,
            handlebars_tag_set,
            main.HandlebarsWhitespaceConfig(remove_whitespace_after_open=True),
        )
        expected_out_txt = "\n".join(
            [
                "{{#if a~}}",
        ...
        out_txt, ambiguous_tags = main._convert_handlebars_to_mustache(
            in_txt,
            handlebars_tag_set,
            main.HandlebarsWhitespaceConfig(remove_whitespace_before_close=True),
        )
        expected_out_txt = "\n".join(
            [
                "{{#if a}}",
        ...
        out_txt, ambiguous_tags = main._convert_handlebars_to_mustache(
            in_txt,
            handlebars_tag_set,
            main.HandlebarsWhitespaceConfig(remove_whitespace_after_close=True),
        )
        expected_out_txt = "\n".join(
            [
                "{{#if a}}",
